...
|---|---|---|---|
| v2.1.4 | 2026-08-13 (KST) | Final | CC BY-NC-SA 4.0 (see [License](#license)) |
...
Current version: **v2.1.4 (2026-08-13)**. Patch release: trademark rendering corrected to the canonical closed-up form GRCnext™ in the grc line of the Part of the ecosystem section, and a pointer to the web application added to How to Use This Repository. No change to the twelve steps, the ten gates, the three tiers, the workshop design or the Your Restaurant addendum.
